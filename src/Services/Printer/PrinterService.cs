...
public class PrinterService : IPrinterService
{
  ...
  private byte[] getTicketBytes(Ticket ticket)
  {
    ...
    return ByteSplicer.Combine(
     ...
     e.PrintLine(Constants.MUSEUM_NAME_ENGLISH),

     e.SetStyles(PrintStyle.None),
     e.PrintLine($"{Constants.MUSEUM_ADDRESS_CITY_ENGLISH}, {Constants.MUSEUM_ADDRESS_DISTRICT_ENGLISH}"),
     e.PrintLine(""),
     e.PrintLine(""),
     e.PrintLine(""),
     ...
     //e.PrintLine("Durbar Square"),
     //e.SetStyles(PrintStyle.None),
     //e.PrintLine("1. [*]  Painting  Section "),
     //e.PrintLine(""),

     //e.SetStyles(PrintStyle.Underline),
     //e.PrintLine("Dattatraya Square"),
     //e.SetStyles(PrintStyle.None),
     //e.PrintLine(""),
     //e.PrintLine("2. [ ] Woodcraft  Section "),
     //e.PrintLine(""),
     //e.PrintLine("3. [ ] Metalcraft Section "),
     e.PrintLine(""),
     e.PrintLine(""),
